...
import Table from "./table-make-appointment-pharmacist";
import { useHistory } from "react-router-dom";

export default function AppointmentsPharmacistTable(){
    ...
    useEffect(() => {
      DerApoServise.getFree(window.location.pathname.split('/')[2])
      .then(response => {
